...
public class NodeChute extends Node implements Tool, Configurable, ActionListener {
  ...
  public NodeChute() {
    ...
    if(img == null) {
      ...
      img = tk.getImage(getClass().getResource("/png/NodeChute.png"));
    }
  }

  public NodeChute(int x, int y) {
    this();
    this.x = x;
    this.y = y;
    color = 15;
