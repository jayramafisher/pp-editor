...
public class NodeMagnet extends NodeConveyor implements Tool, Configurable, ActionListener, ItemListener {
  ...
  public NodeMagnet() {
    ...
    if(img == null) {
      ...
      img = tk.getImage(getClass().getResource("/png/NodeMagnet.png"));
    }
  }

  public NodeMagnet(int x, int y) {
    this();
    this.x = x;
    this.y = y;
    polarity = 1;
  ...
  public JPanel createControls() {
    ...
    panel.add(box);
    JComboBox boxpolar = new JComboBox(new String[]{"+1","-1"});
    box.addActionListener(this);
    panel.add(box);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if(text.equals("+1")) polarity = 1;
    else if(text.equals("-1")) polarity = -1;
    else dir = strToDir((String)box.getSelectedItem());
